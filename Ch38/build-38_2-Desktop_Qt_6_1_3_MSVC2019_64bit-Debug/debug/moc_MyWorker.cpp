...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_MyWorker_t, stringdata0) + ofs), len 
...
QT_MOC_LITERAL(32, 10), // "slotDoWork"
QT_MOC_LITERAL(43, 12) // "setNextValue"

    },
    "MyWorker\0valueChanged\0\0finished\0"
    "slotDoWork\0setNextValue"
};
...
static const uint qt_meta_data_MyWorker[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       3,    0,   41,    2, 0x06,    2 /* Public */,

 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       4,    0,   42,    2, 0x0a,    3 /* Public */,
...
void MyWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->slotDoWork(); break;
        case 3: _t->setNextValue(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWorker::valueChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWorker::finished)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject MyWorker::staticMetaObject = { {
    ...
    qt_meta_stringdata_MyWorker.offsetsAndSize,
    qt_meta_data_MyWorker,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_MyWorker_t
